...
execute_process(
  COMMAND "F:/laragon/bin/git/bin/git.exe" --git-dir=.git show-ref "1.0.1"
  WORKING_DIRECTORY "C:/Users/Administrateur/Desktop/UiT-Narvik-Graphical/Exam/build/_deps/glm-src"
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: 'C:/Users/Administrateur/Desktop/UiT-Narvik-Graphical/Exam/build/_deps/glm-src'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: 'C:/Users/Administrateur/Desktop/UiT-Narvik-Graphical/Exam/build/_deps/glm-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
